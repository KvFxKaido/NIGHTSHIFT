 ...
 * Presentation reads this; nothing in the simulation does.
 */
...
export const ALDER_NEIGHBOURHOODS: readonly AlderNeighbourhood[] = [
  ...
  { id: "central-district", name: "Central District", polygon: [
  ...
  { id: "madrona-ridge", name: "Madrona Ridge", polygon: [
