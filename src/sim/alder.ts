...
const evergreensForBlocks = (blocks:readonly BuildingBlock[], sites:readonly SiteGrounds[]) => createEvergreens([...ALDER_STREETS, ...ARENA_ROADS],
  [...blocks, ...YARD_STRUCTURES, ...GATE_STRUCTURES,...SITE_FENCE_WALLS, YARD_RESERVE, landmarks.broadcastTower, ...ALDER_TREES, ...ALDER_CORNER_SOLIDS, ...ALDER_PARKING_RESERVES, ...sites.flatMap(p=>p.reserves),
...
export function frontageContextForLayout(value:unknown): FrontageContext {
  ...
  return {...ALDER_FRONTAGE_CONTEXT,sites:layout.entries,
    obstacles:[...YARD_STRUCTURES,...GATE_STRUCTURES,...SITE_FENCE_WALLS,landmarks.broadcastTower,...ALDER_TREES,...ALDER_CORNER_SOLIDS,...ALDER_MARKET_UTILITIES,...ALDER_GARAGE_SOLIDS,...ALDER_PARKING_RESERVES,...ALDER_PARKING_SOLIDS,
