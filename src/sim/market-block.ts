...
/** A small authored block. Roads and building footprints retain their released positions. */
...
const oliveEdge = (z: number) => 800 + (-890 - z) * 15 / 31 - 10.8 * Math.hypot(1, 15 / 31) + .05;
...
export const MARKET_ALLEYS = [rect(782, -989, 790, -899), rect(790, -966, 818, -956)];
