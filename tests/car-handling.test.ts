...
const PINNED: Record<string, { revision: number; fingerprint: string }> = {
  ...
  blender: { revision: 3, fingerprint: "6127a6bd" },
  ns01: { revision: 3, fingerprint: "6127a6bd" },
  kestrel: { revision: 3, fingerprint: "936c4335" },
  vesper: { revision: 2, fingerprint: "cbf665e3" },
  latch: { revision: 3, fingerprint: "71c68069" },
  breakwater: { revision: 3, fingerprint: "8df29387" },
